...
decisions</p>
        ...
        <div className="dossier">
          <div className="dossier-title">Field Notes</div>
          <dl>
            <div className="row"><dt>Temperament</dt><dd>Sarcastic, suspicious, occasionally affectionate</dd></div>
            <div className="row"><dt>Known for</dt><dd>Judging your entries in complete silence</dd></div>
            <div className="row"><dt>Associates</dt><dd>Degenerates, holders, one increasingly complicated relationship with Solana</dd></div>
            <div className="row"><dt>Promises</dt><dd>None made. Judgment, unlimited.</dd></div>
            <div className="row"><dt>Tax</dt><dd>0% buy / 0% sell</dd></div>
            <div className="row"><dt>Currently</dt><dd>Watching your bags</dd></div>
          </dl>
        </div>
      </div>
    </section>
